...
function Main()
{
	...
	*/
	 ...
	 createjs.Sound.on("fileload", createjs.proxy(loadHandler2, (this)));
	 createjs.Sound.registerSound("assets/sounds/junkyard/junkyard1.mp3", "sound");
	 /*
...
function handleComplete2(event) {
 ...
 function loadHandler2(event) {
     // This is fired for each sound that is registered.
     var instance = createjs.Sound.play("sound");  // play using id.  Could also use full source path or event.src.
     instance.on("complete", createjs.proxy(handleComplete2, this));
     instance.volume = 0.2;
 }	
