...
var conversations = [
	{actions: [
		...
		{character: "Choco", value: "showMessage('Here, type this into your code panel and run it:<br><br><span class=\"codeExample\">jaxi.run();<br>jaxi.jump();<br>jaxi.run(150);<br>jaxi.jump();<br>jaxi.run(500);</span>', null, 'assets/images/mcChocoIcon.png');", type: "js"}
